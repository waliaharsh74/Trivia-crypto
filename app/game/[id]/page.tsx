...
export default function GamePage() {
  ...
  const [gameState, setGameState] = useState<GameState>({
    ...
    player1Score: 0,
    player2Score: 0,
    player1Address: "0x1234...5678", // This would be the current user's address
    questions: [],
    playerAnswers: [],
  })
  ...
  useEffect(() => {
    const loadGameData = async () => {
      try {
        // In a real implementation, this would fetch game data from the server
        await new Promise((resolve) => setTimeout(resolve, 1500))

        // Mock questions generated by Groq
        ...
        // Simulate player 2 joining after a delay
        setTimeout(() => {
          setGameState((prev) => ({
            ...prev,
            status: "starting",
          ...
          // Start the game after a countdown
          setTimeout(() => {
            setGameState((prev) => ({
              ...prev,
              status: "in-progress",
      ...
      setGameState((prev) => {
        if (prev.timeRemaining <= 1) {
          ...
          if (prev.currentQuestionIndex < prev.questions.length - 1) {
            // If no answer was selected, record as null
            ...
            // Game is complete
            // Update the final answer if needed
            const updatedAnswers = [...prev.playerAnswers]
            if (selectedAnswer !== null) {
              updatedAnswers[prev.currentQuestionIndex] = selectedAnswer
            }
            ...
            // Simulate player 2's final score
